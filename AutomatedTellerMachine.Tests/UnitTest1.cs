...
namespace AutomatedTellerMachine.Tests {
    ...
    public class UnitTest1 {
        ...
        public void FooActionReturnsAboutView() {
            ...
            var result = homeControler.Foo() as ViewResult;
        ...
        public void ContactFormSaysThanks() {
            var homeControler = new HomeController();
            var result = homeControler.Contact("Test") as PartialViewResult;
            Assert.IsNotNull(result.ViewBag.Message);
        }

        [TestMethod]
        public void BalanceIsCorrectAfterDepopsit() {
            var fakeDb = new FakeApplicationDbContext();
            fakeDb.CheckingAccounts = new FakeDbSet<CheckingAccount>();

            var checkingAccount = new CheckingAccount {
                Id = 1, AccountNumber = "0000012345", Balance = 0
            };
